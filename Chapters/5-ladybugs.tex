...
I used \ProgramName{} to improve these models by simulating on a triangular mesh. This mesh is shaped to be more faithful to nature compared to a sphere. The equations remain the activator-depleted substrate formula \citep{meinhardt1982}:
\begin{equation}
