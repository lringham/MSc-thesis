...
When computing the discrete Laplacian, a boundary edge will only have one flanking angle. The other angle is assumed to be 0. This is equivalent to no-flux boundary conditions or Neumann set to 0. To specify Dirichlet boundary conditions, the time step at boundary vertices can be set 0; freezing the concentrations found along the boundary.
