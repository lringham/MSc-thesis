...
As in the grid case, concentrations are associated with cells. However, because a concentration value in a cell is a number, I associate the value with the corresponding vertex of a dual graph. To allow for easy neighbour identification and area calculation, I represent the triangular mesh as a half-edge data structure \citep{marschner2015}. 
\begin{figure}[H]
    \centering
    \incfig{halfEdgeMesh}
