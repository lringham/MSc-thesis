...
\begin{table}[hb]
	...
	\caption {Parameter values for  \textit{Encyclia} and \textit{Kohleria} using Turing reaction-diffusion (Eqn. \ref{eq:turingRD}). $uSat$ represents the maximum value of the $u$. Values separated by commas are used on different regions of the domain.}
