...
Exploring different parameter values at runtime is achieved by using graphical control panels shown in Fig. \ref{fig:GUIexample}. They have controls for growth, rendering, and interactive non-homogeneous parameter specification. 
