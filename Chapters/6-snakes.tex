...
% Chromatoblasts turn into chromatophors if and when they have pigments produced stored inside them? There are many types of chromatophors such as melanocytes
...
In the model there is one morphogen representing the concentration of chromatophores at a location. These chromatophores diffuse and reproduce by mitosis. The chromatophores produce a second morphogen known as a chemoattractant which diffuses and decays. High concentrations of chemoattractant cause chromatophores to group up, causing patterns to sharpen. Mathematically this model is:
