...
\end{figure}
\footnotetext{\url{www.flickr.com/photos/evergladesnps/9099355261/}, Retrieved, October 1, 2019}

% a www.instagram.com/p/BR_e_yGBKaV/?igshid=cyd7oopduf10
% b en.wikipedia.org/wiki/Scarlet_kingsnake
% c www.flickr.com/photos/138578145@N04/26965183857
% d www.flickr.com/photos/evergladesnps/9099355261/
...
\begin{figure}[ht]
	...
	\caption[Model of the Honduran milk snake]{Model of the Honduran milk snake. The activator, $a$, is visualized where concentration values from low to high are represented as dark orange, black, and bright orange. \textbf{a:} The initial state: $a=1$ on the nose and $0$ elsewhere, $s=1$ everywhere. \textbf{b:} The final pattern. \textbf{c:} An image of a real Honduran milk snake. \textit{\CpyMsg{Robert Coral}}.}
	\label{fig:Snake1}
\end{figure}
...
\begin{figure}[ht]
	...
	\caption[Model of the \textit{L. californiae}]{Model of the \textit{L. californiae}. Morphogen $u$ is visualized as white when its value is low and black when high. \textbf{a:} The initial distribution is $u=0$ and $v=1$ everywhere except a lateral stripe  of $u=1$. \textbf{b:} The final pattern. \textbf{c:} An image of a real \textit{L. californiae}. \textit{\CpyMsg{David Steen}.}}
	\label{fig:Snake6}
\end{figure}

\newpage
\footnotetext{\url{https://livingalongsidewildlife.com/?p=1703}, Retrieved October 3, 2019.}
...
\begin{table}[ht]
	...
	\caption[Parameter values for the California kingsnake model]{Parameter values for the California kingsnake model. This model uses the activator-depleted substrate equations (Eqn. \ref{eq:grayscottRD}).}
